...
--------------------------------------------------------------------------------------------------------
local win = library:Window("Yed Ped",[[Hub]],[[ Blox Fruit ]],"7296430216",Enum.KeyCode.RightControl)
local MainTab = win:Tab("General",[[7040391851]])
local Quest_Tab = win:Tab("    Quest & Item",[[9606626859]])
local Shop = win:Tab("Shop",[[9606625251]])
...
Setting_Tab:Toggle("Auto Set Spawn Points","7296430216",true,function(value)
...
Setting_Tab:Toggle("Fast Attack","7296430216",true,function(abc)
	_G.FastAttack = abc
    _G.Remove_Effect = abc
    _G.Remove_Animetion = abc
end)
...
Setting_Tab:Toggle("Bring Mob","7296430216",true,function(value)
...
local Time = MainTab:Label("Executor Time");spawn(function() getgenv().Time = true;while true do wait(.1) UpdateTime() end end);function UpdateTime() local date = os.date("*t");local hour = (date.hour) % 24;local ampm = hour < 12 and "AM" or "PM";local timezone = string.format("%02i:%02i:%02i %s", ((hour -1) % 12) + 1, date.min, date.sec, ampm);local datetime = string.format("%02d/%02d/%04d", date.day, date.month, date.year);local LocalizationService = game:GetService("LocalizationService");local Players = game:GetService("Players");local player = Players.LocalPlayer;local name = player.Name;local result, code = pcall(function()   return LocalizationService:GetCountryRegionForPlayerAsync(player)  end);Time:Set(" : " .. timezone);Time:Set("Executor Time: " .. datetime .. " [ " .. code .. " ]");spawn(function() if getgenv().Time then pcall(function()  while wait() do  Time()  end end) end end) end

Time = MainTab:Label("Server Time")
...
Client = MainTab:Label("FPS Server")
...
MainTab:Label("Auto Farm")
MainTab:Toggle("Auto Farm level","7296430216",_G.AutoFarm,function(value)
    _G.AutoFarm = value
    StopTween(_G.AutoFarm)
end)
local Select_W = MainTab:Dropdown("Select Weapon",Waspon,function(value)
...
MainTab:Label("Settings Farm")
Y = 20
MainTab:Slider("Farming Distance", 0,50,Y, function(vu)
	Y = vu
end)
MainTab:Label("Auto Stats")
MainTab:Toggle("Auto Melee","7296430216",_G.Auto_Melee,function(value)
    _G.Auto_Melee = value
end)
MainTab:Toggle("Auto Defense","7296430216",_G.Auto_Defense,function(value)
    _G.Auto_Defense = value
end)
MainTab:Toggle("Auto Sword","7296430216",_G.Auto_Sword,function(value)
    _G.Auto_Sword = value
end)
MainTab:Toggle("Auto Gun","7296430216",_G.Auto_Gun,function(value)
    _G.Auto_Gun = value
end)
MainTab:Toggle("Auto BloxFruit","7296430216",_G.Auto_BloxFruit,function(value)
    _G.Auto_BloxFruit  = value
end)
MainTab:Label("Exp x2")
local x2Code = {
    "3BVISITS",
    "UPD16",
    "FUDD10",
...
MainTab:Label("Mastery Farm")
MainTab:Toggle("Auto Farm Gun","7296430216",false,function(vu)
...
---------------------------------------------------------------------------------------------------------------
Quest_Tab:Seperator("Bone")

local BoneFarm = Quest_Tab:Toggle("Auto Farm Bone","7296430216",_G.AutoFarmBone,function(value)
...
Quest_Tab:Toggle("Auto Random Surprise","7296430216",_G.Auto_Random_Bone,function(value)
...
Quest_Tab:Seperator("Dought")

local MobKilled = Quest_Tab:Label("Killed")
...
Quest_Tab:Toggle("Auto Dought Boss","7296430216",_G.AutoDoughtBoss,function(value)
                ...
                if game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") then
                    ...
                    if game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") then
                        ...
                        if game:GetService("Workspace").Map.CakeLoaf.BigMirror.Other.Transparency == 1 then
                            ...
                            StartMagnetFarmKatakuri = false
                            topos(CFrame.new(-2099.33, 66.9971, -12128.6)) 
                    end
                end
            end)
        end
...
Quest_Tab:Seperator("Buddy Sword")

Quest_Tab:Toggle("Auto Buddy Sword","7296430216",_G.AutoBudySword,function(value)
    _G.AutoBudySword = value
    StopTween(_G.AutoBudySword)
end)

Quest_Tab:Toggle("Auto Buddy Sword Hop","7296430216",_G.AutoBudySwordHop,function(value)
...
Quest_Tab:Seperator("Elite")

local EliteProgress = Quest_Tab:Label("")
...
Quest_Tab:Toggle("Auto Elite Hunter","7296430216",_G.AutoElitehunter,function(value)
...
Quest_Tab:Toggle("Auto Elite Hunter Hop","7296430216",_G.AutoEliteHunterHop,function(value)
...
Island_Tab:Button("Teleport To Old World",function()
...
Raid_Tab:Toggle("Auto Farm Dungeon","6022668898",_G.Auto_Dungeon,function(value)
    _G.Auto_Dungeon = value
    StopTween(_G.Auto_Dungeon)
end)
Raid_Tab:Dropdown("Select Chips",{"Flame","Ice","Quake","Light","Dark","String","Rumble","Magma","Human: Buddha","Sand","Bird: Phoenix"},function(value)
    _G.SelectChip = value
end)

Raid_Tab:Toggle("Auto Select Dungeon","6022668898",_G.AutoSelectDungeon,function(value)
...
Raid_Tab:Toggle("Auto Buy Chip","6022668898",_G.AutoBuyChip,function(value)
...
Raid_Tab:Toggle("Auto Start Raid","6022668898",_G.Auto_StartRaid,function(value)
